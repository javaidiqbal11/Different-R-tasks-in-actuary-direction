...
# Setting 
ParameterVektor <- c(kappa,alpha,H,psi)

#Optimizing VasKal 
#Tried  optim as well but did not give good result
# nlminb uses BGFS by default, better than NM 

ansvec  <- optim(ParameterVektor,VasKal)
